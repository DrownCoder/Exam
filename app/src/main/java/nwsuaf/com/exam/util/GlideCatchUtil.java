...
public class GlideCatchUtil {
    ...
    /*public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(MainApplication.getInstance().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CARCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    /*public boolean cleanCatchDisk() {
        return deleteFolderFile(MainApplication.getInstance().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CARCH_DIR, true);
    }*/
