...
/** 
 * DAO for table "NETPROBLEM".
*/
public class netproblemDao extends AbstractDao<netproblem, Integer> {

    public static final String TABLENAME = "NETPROBLEM";

    /**
     * Properties of entity netproblem.<br/>
    ...
    public netproblemDao(DaoConfig config) {
        super(config);
    }
    
    public netproblemDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NETPROBLEM\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NETPROBLEM\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, netproblem entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, netproblem entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public netproblem readEntity(Cursor cursor, int offset) {
        netproblem entity = new netproblem( //
    ...
    @Override
    public void readEntity(Cursor cursor, netproblem entity, int offset) {
    ...
    @Override
    protected final Integer updateKeyAfterInsert(netproblem entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public Integer getKey(netproblem entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(netproblem entity) {
